...
class ArticleTitle {
  ...
  static const authServicesImpugnaMultas = 'Impugnar Multas';
  static const authServicesShowMultas = 'Consultar Multas';
  static const authServicesRevisaTramites = 'Revisa tus trámites';
  static const authServicesRevisaTemplate = "Impugnar Multa";
  static const authServiceCrearPerfiles = 'Administrar Perfiles';
  static const authElina = 'Elevate Your Home Cooking Experience';

  static const authDocumentAsociatedImpugnacion = 'Documentos de impugnación';
  static const authDocumentAsociatedCuenta = 'Mis documentos';
  static const authDocumentAsociadoVehiculo = 'Documentos del vehículo';
  static const authDocumentGenerateds = "Mis impugnaciones";
  static const authDocumentSignature = "Documentos Firmados";
...
class ArticleContent {
  static const articleContent1 =
      ''' El Hyundai Tucson, matrícula GNA-1234, es un SUV moderno de color gris titanio con detalles en cromo que realzan su diseño. Este modelo en particular cuenta con un motor de 2.0 litros y transmisión automática, ideal para viajes cómodos y eficientes en carretera o en ciudad. Los rines de aleación de 18 pulgadas le aportan un estilo robusto, mientras que los faros LED de encendido automático ofrecen una visibilidad excelente en condiciones de poca luz.''';
...
List<FaqTileWidget> faqTileWidgets = [
  FaqTileWidget(
    title: '¿Qué es Simón?',
    childrenText: 'Simon es una aplicación diseñada para ayudarte a impugnar multas de tránsito. Está disponible globalmente y permite que los usuarios presenten una solicitud para impugnar multas de forma sencilla y rápida.',
  ),
  FaqTileWidget(
    title: '¿La aplicación Simón es gratuita?',
    childrenText: 'Sí, la aplicación es completamente gratuita para todos los usuarios. Puedes acceder a todas sus funciones sin costo alguno.',
  ),
  FaqTileWidget(
    title: '¿Cómo impugno una multa?',
    childrenText: 'Para impugnar una multa, necesitas tener todos los documentos necesarios subidos y tu vehículo registrado en el sistema. Solo entonces podrás presentar la solicitud de impugnación.',
  ),
  FaqTileWidget(
    title: '¿Cómo cierro sesión en Simón?',
    childrenText: 'Para cerrar sesión, simplemente accede al menú de configuración de la aplicación y selecciona "Cerrar sesión". Esto garantizará que tu cuenta quede protegida.',
  ),
];
