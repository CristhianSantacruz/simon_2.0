  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('About simon_final', style: primarytextStyle(color: appStore.isDarkMode ? Colors.white : Colors.black)),
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Text(
                'simon_final v1.0.0',
                style: TextStyle(color: appStore.isDarkMode ? Colors.white : Colors.black, fontSize: 20),
              ),
            ),
            Divider(thickness: appStore.isDarkMode ? 0.3 : 0.2, color: dividerDarkColor),
            ListView.builder(
              shrinkWrap: true,
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  title: Text(item['text']!, style: primarytextStyle(color: appStore.isDarkMode ? Colors.white : Colors.black)),
                );
              },
            ),
          ],
